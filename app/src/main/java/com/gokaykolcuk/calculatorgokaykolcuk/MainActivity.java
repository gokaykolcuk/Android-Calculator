package com.gokaykolcuk.calculatorgokaykolcuk;
...
public class MainActivity extends Activity  {
    ...
    Button button_delete, button_kareAl, button_percent, button_division, button_add, button_mult, button_subt, button_comma,button_kupAl, button_equal,num_1,num_2,num_3,num_4,num_5,num_6,num_7,num_8,num_9,num_0;
    TextView screen;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_kareAl = findViewById(R.id.button_kareAl);
        button_kupAl = findViewById(R.id.button_kupAl);
        ...
        try {
            button_kareAl.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View view) {
                    if(!screen.getText().toString().equals(""))
                    {
        ...
        try {
            button_kupAl.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View view) {
                    if(!screen.getText().toString().equals(""))
                    {
